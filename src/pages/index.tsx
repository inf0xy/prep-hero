...
const HomePage = () => {
  const { theme, pageLoading } = useAppSelector((state) => {
    const { theme } = state.theme;
    const { pageLoading } = state.navigate;
    return { theme, pageLoading };
  });
        ...
        <div className={`${classes.homepage} ${classes[`homepage--${theme}`]}`}>
          <div className={classes.heading}>
            ...
            <div className={classes.headline}>
              <p>
                Prep Hero is your go-to platform for honing your coding skills
              </p>
          ...
          >
            <div className={classes.message}>
              ...
              <p>
                Explore a vast library of coding challenges that cover a wide
                range of topics and difficulty levels. Improve your problem
                solving skills, and gain confidence in your coding abilities.
              </p>
            </div>
          ...
          <div className={classes['second-section']}>
            ...
            <div className={classes.message}>
              ...
              <p>
                ...
                performance analytics. Get detailed insights into your coding
          ...
          <div className={classes['third-section']}>
            <div className={classes.message}>
              ...
              <p>
                Access a curated collection of commonly asked interview
                behavioral questions, and variety of resources to learn
                effective strategies to tackle coding problems.
              </p>
            </div>
