  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Prep Hero is your go-to platform for honing your coding skills and acing technical interviews."
        />
      </Head>
        ...
        <div className={classes['third-section']}>
          <div className={classes.message}>
            ...
            <p>
              ...
              questions, and variety of resources to learn effective strategies
              to tackle coding problems.
            </p>
          </div>
