...
const ProblemDetailPageDesktop: React.FC<ProblemDetailPageDesktopProps> = ({
  selectedProblem
}) => {
      ...
      {windowWidth && (
        <>
          {!debugging ? (
            ...
            >
              <div
                className={`${classes.detail} ${classes[`detail--${theme}`]}`}
              >
...
export default ProblemDetailPageDesktop;
